      ...
      <div className="flex min-h-screen" style={{ background: 'var(--bg)' }}>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          >
            ...
            <span
              className="flex-shrink-0 text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded"
              style={{ background: 'rgba(255,59,31,0.12)', color: 'var(--red)', border: '1px solid rgba(255,59,31,0.25)' }}
            >
              Admin
            </span>
          </header>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-semibold" style={{ fontFamily: 'var(--font-display)', color: 'var(--text-1)' }}>
                Admin Console
              </span>
            </div>
            <span
              className="text-[10px] font-semibold uppercase tracking-wider px-2.5 py-1 rounded"
              style={{ background: 'rgba(255,59,31,0.1)', color: 'var(--red)', border: '1px solid rgba(255,59,31,0.22)' }}
            >
              Admin
            </span>
          </header>
