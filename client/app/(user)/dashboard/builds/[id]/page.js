...
import { useGetBuildByIdQuery } from '@/services/buildsApi'
...
export default function UserBuildDetailPage({ params }) {
  const { id } = params

  const { data, isLoading, isError, refetch } = useGetBuildByIdQuery(id, { skip: !id })
