...
import {
  LayoutDashboard, Cpu, BookmarkCheck, ArrowLeftRight,
  BarChart2, DollarSign, BookOpen, Clock, LogOut, X, ChevronRight,
} from 'lucide-react'
  ...
  return (
    <Link
      ...
      style={{
        ...
        border:      isActive ? '1px solid rgba(255,59,31,0.18)' : '1px solid transparent',
